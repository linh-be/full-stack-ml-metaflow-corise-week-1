...
def labeling_function(row):
    ...
    We use the rating only, and return a binary positive or negative sentiment score based on an arbitrarty cutoff.
    """
...
class BaselineNLPFlow(FlowSpec):
    ...
    def baseline(self):
        ...
        # predict majority class as baseline model
        self.df["baseline_model"] = 1
        # persist "predictions" to training and validation datasets
        self.traindf["baseline_model"] = 1
    ...
    def end(self):
        ...
        print(self.type_i_errors.shape[0]) # remove later
        ...
        print(self.type_ii_errors.shape[0]) # remove later
